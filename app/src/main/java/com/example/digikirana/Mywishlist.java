...
public class Mywishlist extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        wishlistModelList.add(new WishlistModel(R.drawable.maggie1, "Masala Maggie ", "Rs 350/-"));
        wishlistModelList.add(new WishlistModel(R.drawable.lays, "Lays  ", "Rs 25/-"));
        wishlistModelList.add(new WishlistModel(R.drawable.almonds, "Almonds ", "Rs 950/-"));
